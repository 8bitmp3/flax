# An annotated image classification example with Flax
...
1. Write a training step function that:
  ...
  - Applies a [pytree]([pytree]([pytrees](https://jax.readthedocs.io/en/latest/pytrees.html#pytrees-and-jax-functions)) of gradients ([`flax.optim.Optimizer.apply_gradient`](https://flax.readthedocs.io/en/latest/flax.optim.html#flax.optim.Optimizer.apply_gradient)) to the optimizer to update the model's parameters.
